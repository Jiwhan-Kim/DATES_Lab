...
if __name__ == "__main__":
    ...
    model   = M.Inception_v1_better().to(device)
    trainer = T.SGDMC_Trainer(lr=0.0015, momentum=0.9, weight_decay=0.00001, model=model, device=device)
    ...
    if path.exists("./model_params_Inception_v1_better.pth"):
        model.load_state_dict(torch.load("./model_params_Inception_v1_better.pth"))
    ...
    torch.save(model.state_dict(), 'model_params_Inception_v1_better.pth')
