...
if __name__ == "__main__":
    ...
    trainer = T.SGDMC_Trainer(lr=0.01, momentum=0.92, weight_decay=0.00015, model=model, device=device)
    ...
    if path.exists("./model_params_ResNet_better_dropout.pth"):
        model.load_state_dict(torch.load("./model_params_ResNet_better_dropout.pth"))
    ...
    torch.save(model.state_dict(), 'model_params_ResNet_better_dropout.pth')
